...
WebUI.setText(findTestObject('LoginPage/input_Username_username'), 'John Doe')

WebUI.setEncryptedText(findTestObject('LoginPage/input_Password_password'), 'g3/DOGG74jC3Flrr3yH+3D/yKbOqqUNM')
